		...
		>
			...
			<div className="w-4/5 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
				<div className="text-center p-3 relative bg-[#50c519]" ref={statsRef}>
					<div>
						<span className="text-white text-[69px]"><CountUp start={0} end={14} duration={4} redraw={statsVisible}/></span>
				...
				<div className="text-center p-3 relative bg-[#e8ac05]">
					<div>
						<span className="text-white text-[69px]"><CountUp start={0} end={100} duration={3.5}  redraw={statsVisible}/></span>
						<span className="text-white text-[69px]">%</span>
					</div>
				...
				<div className="text-center p-3 relative bg-[#50c519]">
					<div>
						<span className="text-white text-[69px]"><CountUp start={0} end={25} duration={4}  redraw={statsVisible}/></span>
						<span className="text-white text-[69px]">+</span>
					</div>
